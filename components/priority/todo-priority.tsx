    ...
    <div className='grid gap-2'>
      ...
      {isOpen && 
        <div className="bg-snow grid w-full">
          ...
          <button onClick={() => handlePrioritySelection("HIGH")}className="px-6 py-3 text-center text-red-600 font-semibold hover:bg-white transition-all duration-300">
            HIGH
          </button>
        </div>
      }
